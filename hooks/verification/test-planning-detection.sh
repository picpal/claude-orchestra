...
# 테스트 2: Plan-Checker 완료 감지
run_detection_test "Plan-Checker 감지" "planCheckerCompleted" "Plan-Checker: 놓친 질문 확인"

# 테스트 3: Planner 완료 감지
run_detection_test "Planner 감지" "plannerCompleted" "Planner: TODO 분석"

# 테스트 4: Planner vs Plan-Checker 구분 (false positive 방지)
# Plan-Checker가 실행되면 plannerCompleted는 설정되지 않아야 함
run_negative_test "Plan-Checker에서 Planner 오탐지 방지" "plannerCompleted" "Plan-Checker: planner 결과 검토"
